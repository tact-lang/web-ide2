 ...
 *--------------------------------------------------------*/
(function() {
var __m = ["require","exports","vs/base/common/path","vs/base/common/platform","vs/base/common/strings","vs/base/common/extpath","vs/base/common/charCode","vs/base/common/uri","vs/base/common/resources","vs/base/common/async","vs/base/common/glob","vs/base/common/symbols","vs/base/common/network","vs/base/common/errors","vs/base/common/cancellation","vs/workbench/services/search/common/getFileResults","vs/workbench/services/search/common/ignoreFile","vs/base/common/types","vs/base/common/event","vs/base/common/lifecycle","vs/base/common/lazy","vs/base/common/arrays","vs/base/common/map","vs/editor/common/core/range","vs/workbench/services/search/worker/localFileSearch"];
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[5/*vs/base/common/extpath*/], __M([0/*require*/,1/*exports*/,6/*vs/base/common/charCode*/,2/*vs/base/common/path*/,3/*vs/base/common/platform*/,4/*vs/base/common/strings*/,17/*vs/base/common/types*/]), function (require, exports, charCode_1, path_1, platform_1, strings_1, types_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$xg = $xg;
    exports.$yg = $yg;
...
define(__m[12/*vs/base/common/network*/], __M([0/*require*/,1/*exports*/,13/*vs/base/common/errors*/,3/*vs/base/common/platform*/,4/*vs/base/common/strings*/,7/*vs/base/common/uri*/,2/*vs/base/common/path*/]), function (require, exports, errors, platform, strings_1, uri_1, paths) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define(__m[8/*vs/base/common/resources*/], __M([0/*require*/,1/*exports*/,6/*vs/base/common/charCode*/,5/*vs/base/common/extpath*/,12/*vs/base/common/network*/,2/*vs/base/common/path*/,3/*vs/base/common/platform*/,4/*vs/base/common/strings*/,7/*vs/base/common/uri*/]), function (require, exports, charCode_1, extpath, network_1, paths, platform_1, strings_1, uri_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[9/*vs/base/common/async*/], __M([0/*require*/,1/*exports*/,14/*vs/base/common/cancellation*/,13/*vs/base/common/errors*/,18/*vs/base/common/event*/,19/*vs/base/common/lifecycle*/,8/*vs/base/common/resources*/,3/*vs/base/common/platform*/,11/*vs/base/common/symbols*/,20/*vs/base/common/lazy*/]), function (require, exports, cancellation_1, errors_1, event_1, lifecycle_1, resources_1, platform_1, symbols_1, lazy_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[10/*vs/base/common/glob*/], __M([0/*require*/,1/*exports*/,21/*vs/base/common/arrays*/,9/*vs/base/common/async*/,6/*vs/base/common/charCode*/,5/*vs/base/common/extpath*/,22/*vs/base/common/map*/,2/*vs/base/common/path*/,3/*vs/base/common/platform*/,4/*vs/base/common/strings*/]), function (require, exports, arrays_1, async_1, charCode_1, extpath_1, map_1, path_1, platform_1, strings_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[15/*vs/workbench/services/search/common/getFileResults*/], __M([0/*require*/,1/*exports*/,23/*vs/editor/common/core/range*/]), function (require, exports, range_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$7uc = void 0;
    const $7uc = (bytes, pattern, options) => {
        let text;
        ...
        if (patternIndecies.length) {
            ...
            for (const { matchStartIndex, matchedText } of patternIndecies) {
                ...
                const fileRange = new range_1.$Ot(startLine, matchStartIndex - lineRanges[startLine].start, endLine, matchStartIndex + matchedText.length - lineRanges[endLine].start);
                const previewRange = new range_1.$Ot(0, matchStartIndex - lineRanges[startLine].start - offset, endLine - startLine, matchStartIndex + matchedText.length - lineRanges[endLine].start - (endLine === startLine ? offset : 0));
                const match = {
                    ranges: fileRange,
...
define(__m[16/*vs/workbench/services/search/common/ignoreFile*/], __M([0/*require*/,1/*exports*/,10/*vs/base/common/glob*/]), function (require, exports, glob) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$1sb = void 0;
    ...
    class $1sb {
        ...
        d(lines, dirPath, trimForExclusions) {
            ...
            return glob.$Ak(includeExpression, { trimForExclusions });
        }
...
define(__m[24/*vs/workbench/services/search/worker/localFileSearch*/], __M([0/*require*/,1/*exports*/,10/*vs/base/common/glob*/,7/*vs/base/common/uri*/,2/*vs/base/common/path*/,14/*vs/base/common/cancellation*/,15/*vs/workbench/services/search/common/getFileResults*/,16/*vs/workbench/services/search/common/ignoreFile*/,4/*vs/base/common/strings*/,9/*vs/base/common/async*/,8/*vs/base/common/resources*/]), function (require, exports, glob, uri_1, paths, cancellation_1, getFileResults_1, ignoreFile_1, strings_1, async_1, resources_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class LocalFileSearchSimpleWorker {
        ...
        async listDirectory(handle, query, folderQuery, ignorePathCasing, queryId) {
            ...
            const extUri = new resources_1.$8g(() => ignorePathCasing);
        ...
        async searchDirectory(handle, query, folderQuery, ignorePathCasing, queryId) {
            ...
            return time('searchInFiles', async () => {
                ...
                const processFile = async (file) => {
                    ...
                    const fileResults = (0, getFileResults_1.$7uc)(bytes, pattern, {
        ...
        async h(handle, queryProps, folderQuery, extUri, onFile, token) {
            const folderExcludes = glob.$Ak(folderQuery.excludePattern ?? {}, { trimForExclusions: true });
            ...
            const processDirectory = async (directory, prior, ignoreFile) => {
                if (!folderQuery.disregardIgnoreFiles) {
                    ...
                    await Promise.all(ignoreFiles.map(async (file) => {
                        ...
                        ignoreFile = new ignoreFile_1.$1sb(ignoreContents, prior, ignoreFile);
                    }));
                }
    ...
    function createSearchRegExp(options) {
        return (0, strings_1.$qf)(options.pattern, !!options.isRegExp, {
    ...
    function pathIncludedInQuery(queryProps, path, extUri) {
        if (queryProps.excludePattern && glob.$zk(queryProps.excludePattern, path)) {
            return false;
        }
        if (queryProps.includePattern || queryProps.usingSearchPaths) {
            if (queryProps.includePattern && glob.$zk(queryProps.includePattern, path)) {
                return true;
            }
            ...
            if (queryProps.usingSearchPaths) {
                return !!queryProps.folderQueries && queryProps.folderQueries.some(fq => {
                    ...
                    if (extUri.isEqualOrParent(uri, searchPath)) {
                        const relPath = paths.$lc(searchPath.path, uri.path);
