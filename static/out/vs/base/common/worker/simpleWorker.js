 ...
 *--------------------------------------------------------*/
(function() {
var __m = ["require","exports","vs/base/common/errors","vs/base/common/functional","vs/base/common/lifecycle","vs/base/common/event","vs/base/common/arraysFind","vs/base/common/charCode","vs/base/common/collections","vs/base/common/arrays","vs/base/common/iterator","vs/base/common/lazy","vs/base/common/linkedList","vs/base/common/map","vs/base/common/platform","vs/base/common/stopwatch","vs/base/common/cancellation","vs/base/common/cache","vs/base/common/types","vs/base/common/objects","vs/base/common/uint","vs/base/common/strings","vs/base/common/worker/simpleWorker"];
...
define(__m[6/*vs/base/common/arraysFind*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    ...
    exports.$pb = $pb;
    exports.$qb = $qb;
    function $eb(array, predicate) {
        const idx = $fb(array, predicate);
        if (idx === -1) {
            return undefined;
        }
        return array[idx];
    }
    function $fb(array, predicate, fromIndex = array.length - 1) {
     ...
     */
    function $gb(array, predicate) {
        const idx = $hb(array, predicate);
     ...
     */
    function $hb(array, predicate, startIdx = 0, endIdxEx = array.length) {
        let i = startIdx;
        let j = endIdxEx;
        while (i < j) {
     ...
     */
    function $ib(array, predicate) {
        const idx = $jb(array, predicate);
    ...
    function $kb(array, predicate, startIdx = 0, endIdxEx = array.length) {
        const idx = $jb(array, predicate, startIdx, endIdxEx);
    ...
    class $lb {
        ...
        findLastMonotonous(predicate) {
            ...
            const idx = $hb(this.e, predicate, this.c);
            this.c = idx + 1;
    ...
    */
    function $ob(array, comparator) {
        return $mb(array, (a, b) => -comparator(a, b));
    }
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[7/*vs/base/common/charCode*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[8/*vs/base/common/collections*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    var _a;
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$g = void 0;
...
define(__m[2/*vs/base/common/errors*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$bb = exports.$ab = exports.$_ = exports.$$ = exports.$0 = exports.$8 = exports.$4 = exports.$V = exports.$U = void 0;
    ...
    exports.$4 = $4;
    /**
     * @deprecated use {@link $4 `new CancellationError()`} instead
     */
    function $5() {
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[9/*vs/base/common/arrays*/], __M([0/*require*/,1/*exports*/,2/*vs/base/common/errors*/,6/*vs/base/common/arraysFind*/]), function (require, exports, errors_1, arraysFind_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$_b = exports.$$b = exports.$0b = exports.$8b = exports.$7b = exports.CompareResult = void 0;
    exports.$rb = $rb;
    exports.$sb = $sb;
    exports.$tb = $tb;
    exports.$ub = $ub;
    ...
    function $tb(one, other, itemEquals = (a, b) => a === b) {
        if (one === other) {
            return true;
        }
        if (!one || !other) {
     ...
     * @return See {@link $wb}
     */
    function $vb(array, key, comparator) {
        return $wb(array.length, i => comparator(array[i], key));
    }
    /**
     ...
     */
    function $wb(length, compareToKey) {
    ...
    function $xb(nth, data, compare) {
        ...
        if (nth < lower.length) {
            return $xb(nth, lower, compare);
        }
        else if (nth < lower.length + pivots.length) {
            return pivots[0];
        }
        else {
            return $xb(nth - (lower.length + pivots.length), higher, compare);
        }
    }
    function $yb(data, compare) {
        const result = [];
     ...
     */
    function* $zb(items, shouldBeGrouped) {
        let currentGroup;
        let last;
    ...
    function $Db(before, after, compare) {
        const splices = $Cb(before, after, compare);
        const removed = [];
        const added = [];
     ...
     * @return The first n elements from array when sorted with compare.
     */
    function $Fb(array, compare, n, batch, token) {
        if (n === 0) {
    ...
    function topStep(array, compare, result, i, m) {
        for (const n = result.length; i < m; i++) {
            ...
            if (compare(element, result[n - 1]) < 0) {
                result.pop();
                const j = (0, arraysFind_1.$jb)(result, e => compare(element, e) < 0);
     ...
     */
    function $Lb(array, keyFn = value => value) {
        const seen = new Set();
    ...
    function $Pb(one, other, equals = (a, b) => a === b) {
        let result = 0;
    ...
    */
     ...
     */
    async function $ac(array, predicate) {
...
define(__m[3/*vs/base/common/functional*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
     ...
     */
    function $cb(fn, fnDidRunCallback) {
        const _this = this;
        let didCall = false;
        let result;
        return function () {
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[10/*vs/base/common/iterator*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[11/*vs/base/common/lazy*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$T = void 0;
    class $T {
...
define(__m[13/*vs/base/common/map*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    ...
    var _a, _b, _c;
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$Hc = exports.$Gc = exports.$Fc = exports.$Ec = exports.$Dc = exports.$Cc = exports.Touch = exports.$Bc = exports.$Ac = void 0;
    exports.$xc = $xc;
    exports.$yc = $yc;
    exports.$zc = $zc;
    exports.$Ic = $Ic;
    function $xc(map, key, value) {
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[4/*vs/base/common/lifecycle*/], __M([0/*require*/,1/*exports*/,9/*vs/base/common/arrays*/,8/*vs/base/common/collections*/,13/*vs/base/common/map*/,3/*vs/base/common/functional*/,10/*vs/base/common/iterator*/]), function (require, exports, arrays_1, collections_1, map_1, functional_1, iterator_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
        ...
        computeLeakingDisposables(maxReported = 10, preComputedLeaks) {
            ...
            for (const leaking of uncoveredLeakingObjs.slice(0, maxReported)) {
                ...
                for (let i = 0; i < stackTracePath.length; i++) {
                    ...
                    const continuations = (0, collections_1.$c)([...prevStarts].map(d => getStackTracePath(d)[i]), v => v);
...
define(__m[14/*vs/base/common/platform*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$J = exports.$I = exports.$H = exports.$G = exports.$F = exports.OS = exports.OperatingSystem = exports.$C = exports.$B = exports.$A = exports.$z = exports.$y = exports.Language = exports.$x = exports.$w = exports.$v = exports.$u = exports.$t = exports.$s = exports.$r = exports.$q = exports.$p = exports.$o = exports.$n = exports.$m = exports.$l = exports.$k = exports.$j = exports.Platform = exports.$h = void 0;
    exports.$i = $i;
    exports.$E = $E;
    exports.$K = $K;
    exports.$h = 'en';
    ...
    let _language = exports.$h;
    let _platformLocale = exports.$h;
    ...
    if (typeof nodeProcess === 'object') {
        ...
        if (rawNlsConfig) {
            try {
                ...
                _language = nlsConfig.resolvedLanguage || exports.$h;
    ...
    // Web environment
        ...
        _isWeb = true;
        // VSCODE_GLOBALS: NLS
        _language = globalThis._VSCODE_NLS_LANGUAGE || exports.$h;
    ...
    exports.$j = _isWindows;
    exports.$k = _isMacintosh;
    exports.$l = _isLinux;
    exports.$m = _isLinuxSnap;
    exports.$n = _isNative;
    exports.$o = _isElectron;
    exports.$p = _isWeb;
    exports.$q = (_isWeb && typeof $globalThis.importScripts === 'function');
    exports.$r = exports.$q ? $globalThis.origin : undefined;
    exports.$s = _isIOS;
    exports.$t = _isMobile;
    /**
    ...
    (function (Language) {
        ...
        function isDefaultVariant() {
            if (exports.$x.length === 2) {
                return exports.$x === 'en';
            }
            else if (exports.$x.length >= 3) {
                return exports.$x[0] === 'e' && exports.$x[1] === 'n' && exports.$x[2] === '-';
            }
            else {
                return false;
            }
     ...
     */
    exports.$z = _platformLocale;
    /**
     * The translations that are available through language packs.
     */
    exports.$A = _translationsConfigFile;
    exports.$B = (typeof $globalThis.postMessage === 'function' && !$globalThis.importScripts);
    /**
    ...
    exports.$F = !!(exports.$w && exports.$w.indexOf('Chrome') >= 0);
    exports.$G = !!(exports.$w && exports.$w.indexOf('Firefox') >= 0);
    exports.$H = !!(!exports.$F && (exports.$w && exports.$w.indexOf('Safari') >= 0));
    exports.$I = !!(exports.$w && exports.$w.indexOf('Edg/') >= 0);
    exports.$J = !!(exports.$w && exports.$w.indexOf('Android') >= 0);
    function $K(osVersion) {
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[15/*vs/base/common/stopwatch*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$fe = void 0;
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[5/*vs/base/common/event*/], __M([0/*require*/,1/*exports*/,2/*vs/base/common/errors*/,3/*vs/base/common/functional*/,4/*vs/base/common/lifecycle*/,12/*vs/base/common/linkedList*/,15/*vs/base/common/stopwatch*/]), function (require, exports, errors_1, functional_1, lifecycle_1, linkedList_1, stopwatch_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$ve = exports.$ue = exports.$te = exports.$se = exports.$re = exports.$qe = exports.$pe = exports.$oe = exports.$ne = exports.$me = exports.$le = exports.$ke = exports.$je = exports.$he = exports.Event = void 0;
    exports.$ie = $ie;
    // -----------------------------------------------------------------------------------------------------------------------
    ...
    (function (Event) {
        ...
        function fromNodeEventEmitter(emitter, eventName, map = id => id) {
            ...
            const result = new $le({ onWillAddFirstListener: onFirstListenerAdd, onDidRemoveLastListener: onLastListenerRemove });
            return result.event;
        }
         ...
         *
         * This is similar to {@link $ue} but allows instantiating and forwarding
    ...
    class $he {
        ...
        constructor(name) {
            ...
            this.durations = [];
            this.name = `${name}_${$he.f++}`;
            $he.all.add(this);
        }
        start(listenerCount) {
            this.g = new stopwatch_1.$fe();
    ...
    class LeakageMonitor {
        ...
        check(stack, listenerCount) {
            ...
            if (this.h <= 0) {
                ...
                const error = new $je(message, topStack);
                this.j(error);
            }
            return () => {
                const count = (this.g.get(stack.value) || 0);
    ...
    class $le {
        constructor(options) {
            this.z = 0;
            this.f = options;
            this.g = (_globalLeakWarningThreshold > 0 || this.f?.leakWarningThreshold)
                ? new LeakageMonitor(options?.onListenerError ?? errors_1.$Y, this.f?.leakWarningThreshold ?? _globalLeakWarningThreshold) :
                undefined;
            this.j = this.f?._profName ? new $he(this.f._profName) : undefined;
        ...
        get event() {
            this.q ??= (callback, thisArgs, disposables) => {
                if (this.g && this.z > this.g.threshold ** 2) {
                    ...
                    const error = new $ke(`${message}. HINT: Stack shows most frequent listener (${tuple[1]}-times)`, tuple[0]);
    ...
    exports.$le = $le;
    const $me = () => new EventDeliveryQueuePrivate();
    exports.$me = $me;
    ...
    class $re {
        ...
        add(event) {
            ...
            return (0, lifecycle_1.$Sc)((0, functional_1.$cb)(dispose));
        }
        j() {
            this.g = true;
    ...
    class $se {
        constructor(items, onAddItem, onRemoveItem, getEvent) {
            ...
            const multiplexer = this.f.add(new $re());
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[16/*vs/base/common/cancellation*/], __M([0/*require*/,1/*exports*/,5/*vs/base/common/event*/]), function (require, exports, event_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$we = exports.CancellationToken = void 0;
    exports.$xe = $xe;
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[17/*vs/base/common/cache*/], __M([0/*require*/,1/*exports*/,16/*vs/base/common/cancellation*/]), function (require, exports, cancellation_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$_e = exports.$$e = exports.$9e = void 0;
    exports.$0e = $0e;
    class $9e {
        constructor(b) {
            this.b = b;
...
define(__m[18/*vs/base/common/types*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
     ...
     */
    function $fg(value) {
        return Array.isArray(value) && value.every(elem => $eg(elem));
    }
    /**
     ...
     */
    function $ng(obj) {
        return ($lg(obj) || obj === null);
    }
    function $og(condition, type) {
        if (!condition) {
     ...
     */
    function $tg(...objects) {
        return objects.length > 0 && objects.every($sg);
    }
    function $ug(args, constraints) {
        const len = Math.min(args.length, constraints.length);
        for (let i = 0; i < len; i++) {
            $vg(args[i], constraints[i]);
        }
    }
    function $vg(arg, constraint) {
        if ($eg(constraint)) {
            if (typeof arg !== constraint) {
                throw new Error(`argument does not match constraint: typeof ${constraint}`);
            }
        }
        else if ($sg(constraint)) {
            try {
            ...
            if (!$ng(arg) && arg.constructor === constraint) {
                return;
            }
...
define(__m[19/*vs/base/common/objects*/], __M([0/*require*/,1/*exports*/,18/*vs/base/common/types*/]), function (require, exports, types_1) {
    ...
    function $eo(obj) {
        ...
        Object.entries(obj).forEach(([key, value]) => {
            result[key] = value && typeof value === 'object' ? $eo(value) : value;
        });
        return result;
    }
    function $fo(obj) {
        ...
        while (stack.length > 0) {
            ...
            for (const key in obj) {
                if (_hasOwnProperty.call(obj, key)) {
                    const prop = obj[key];
                    if (typeof prop === 'object' && !Object.isFrozen(prop) && !(0, types_1.$hg)(prop)) {
                        stack.push(prop);
                    }
                }
            }
     ...
     */
    function $ho(destination, source, overwrite = true) {
        if (!(0, types_1.$gg)(destination)) {
            return source;
        }
        if ((0, types_1.$gg)(source)) {
            Object.keys(source).forEach(key => {
                if (key in destination) {
                    if (overwrite) {
                        if ((0, types_1.$gg)(destination[key]) && (0, types_1.$gg)(source[key])) {
                            $ho(destination[key], source[key], overwrite);
                        }
                        else {
    ...
    function $io(one, other) {
        ...
        if (Array.isArray(one)) {
            ...
            otherKeys.sort();
            if (!$io(oneKeys, otherKeys)) {
                return false;
            }
            for (i = 0; i < oneKeys.length; i++) {
                if (!$io(one[oneKeys[i]], other[oneKeys[i]])) {
                    return false;
                }
            }
        }
    ...
    function $jo(obj) {
        ...
        return JSON.stringify(obj, (key, value) => {
            if ((0, types_1.$gg)(value) || Array.isArray(value)) {
                if (seen.has(value)) {
                    return '[Circular]';
                }
                else {
    ...
    function $ko(base, target) {
        ...
        targetKeys.forEach(k => {
            ...
            if (!$io(baseValue, targetValue)) {
                result[k] = targetValue;
            }
        });
        return result;
    }
    function $lo(target, key) {
        const lowercaseKey = key.toLowerCase();
        const equivalentKey = Object.keys(target).find(k => k.toLowerCase() === lowercaseKey);
        return equivalentKey ? target[equivalentKey] : target[key];
    }
    function $mo(obj, predicate) {
        const result = Object.create(null);
    ...
    function $po(methodNames, invoke) {
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[21/*vs/base/common/strings*/], __M([0/*require*/,1/*exports*/,17/*vs/base/common/cache*/,7/*vs/base/common/charCode*/,11/*vs/base/common/lazy*/,20/*vs/base/common/uint*/]), function (require, exports, cache_1, charCode_1, lazy_1, uint_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$dg = exports.$cg = exports.$bg = exports.GraphemeBreakType = exports.$4f = exports.$Vf = exports.$Of = exports.$Nf = void 0;
    exports.$cf = $cf;
    exports.$df = $df;
    exports.$ef = $ef;
    exports.$ff = $ff;
    ...
    function $jf(value, maxLength, suffix = '…') {
        if (value.length <= maxLength) {
            return value;
        }
        return `${value.substr(0, maxLength)}${suffix}`;
    }
    function $kf(value, maxLength, suffix = '…') {
        if (value.length <= maxLength) {
            return value;
        }
     ...
     */
    function $lf(haystack, needle = ' ') {
        const trimmed = $mf(haystack, needle);
        return $nf(trimmed, needle);
    }
    /**
    ...
    function $qf(searchString, isRegex, options = {}) {
        if (!searchString) {
            throw new Error('Cannot create regex from empty string');
        }
        if (!isRegex) {
            searchString = $hf(searchString);
        }
     ...
     */
    function $vf(str, start = 0, end = str.length) {
     ...
     * If string is empty or contains only whitespaces, returns -1
     */
    function $wf(str, startIndex = str.length - 1) {
     ...
     */
    function $xf(str, search, replacer) {
        const parts = [];
        let last = 0;
    ...
    function $zf(a, b, aStart = 0, aEnd = a.length, bStart = 0, bEnd = b.length) {
    ...
    function $Af(a, b) {
        return $Bf(a, b, 0, a.length, 0, b.length);
    }
    function $Bf(a, b, aStart = 0, aEnd = a.length, bStart = 0, bEnd = b.length) {
        for (; aStart < aEnd && bStart < bEnd; aStart++, bStart++) {
            ...
            if (codeA >= 128 || codeB >= 128) {
                ...
                return $zf(a.toLowerCase(), b.toLowerCase(), aStart, aEnd, bStart, bEnd);
            }
    ...
    function $Ff(a, b) {
        return a.length === b.length && $Bf(a, b) === 0;
    }
    function $Gf(str, candidate) {
        const candidateLength = candidate.length;
        if (candidate.length > str.length) {
            return false;
        }
        return $Bf(str, candidate, 0, candidateLength) === 0;
    }
    /**
     ...
     */
    function $Jf(charCode) {
        return (0xD800 <= charCode && charCode <= 0xDBFF);
    }
    /**
     * See http://en.wikipedia.org/wiki/Surrogate_pair
     */
    function $Kf(charCode) {
        return (0xDC00 <= charCode && charCode <= 0xDFFF);
    }
    /**
     * See http://en.wikipedia.org/wiki/Surrogate_pair
     */
    function $Lf(highSurrogate, lowSurrogate) {
        return ((highSurrogate - 0xD800) << 10) + (lowSurrogate - 0xDC00) + 0x10000;
    }
    /**
     * get the code point that begins at offset `offset`
     */
    function $Mf(str, len, offset) {
        const charCode = str.charCodeAt(offset);
        if ($Jf(charCode) && offset + 1 < len) {
            const nextCharCode = str.charCodeAt(offset + 1);
            if ($Kf(nextCharCode)) {
                return $Lf(charCode, nextCharCode);
            }
        }
        return charCode;
    }
    ...
    function getPrevCodePoint(str, offset) {
        ...
        if ($Kf(charCode) && offset > 1) {
            const prevCharCode = str.charCodeAt(offset - 2);
            if ($Jf(prevCharCode)) {
                return $Lf(prevCharCode, charCode);
            }
        }
        return charCode;
    }
    class $Nf {
        ...
        prevCodePoint() {
            ...
            this.e -= (codePoint >= uint_1.Constants.UNICODE_SUPPLEMENTARY_PLANE_BEGIN ? 2 : 1);
            return codePoint;
        }
        nextCodePoint() {
            const codePoint = $Mf(this.c, this.d, this.e);
            this.e += (codePoint >= uint_1.Constants.UNICODE_SUPPLEMENTARY_PLANE_BEGIN ? 2 : 1);
            return codePoint;
        }
        eol() {
    ...
    exports.$Of = $Of;
    function $Pf(str, initialOffset) {
        const iterator = new $Of(str, initialOffset);
        return iterator.nextGraphemeLength();
    }
    function $Qf(str, initialOffset) {
        const iterator = new $Of(str, initialOffset);
        return iterator.prevGraphemeLength();
    }
    function $Rf(str, offset) {
        if (offset > 0 && $Kf(str.charCodeAt(offset))) {
            offset--;
        }
        const endOffset = offset + $Pf(str, offset);
        const startOffset = endOffset - $Qf(str, endOffset);
        return [startOffset, endOffset];
    }
    function $Sf(str) {
        const iterator = new $Of(str);
        let length = 0;
        while (!iterator.eol()) {
            length++;
    ...
    exports.$Vf = /[\u2028\u2029]/; // LINE SEPARATOR (LS) or PARAGRAPH SEPARATOR (PS)
    /**
     * Returns true if `str` contains unusual line terminators, like LS or PS
     */
    function $Wf(str) {
        return exports.$Vf.test(str);
    }
    function $Xf(charCode) {
     ...
     */
    function $3f(str) {
        return $2f(str).replace(PROMPT_NON_PRINTABLE, '');
    }
    // -- UTF-8 BOM
    exports.$4f = String.fromCharCode(charCode_1.CharCode.UTF8_BOM);
    function $5f(str) {
        return !!(str && str.length > 0 && str.charCodeAt(0) === charCode_1.CharCode.UTF8_BOM);
    }
    function $6f(str) {
        return $5f(str) ? str.substr(1) : str;
    }
    /**
     * Checks if the characters of the provided query string are included in the
     * target string. The characters do not have to be contiguous within the string.
     */
    function $7f(target, query) {
        if (!target || !query) {
    ...
    function $8f(target, ignoreEscapedChars = false) {
        if (!target) {
            return false;
        }
    ...
    class GraphemeBreakTree {
        ...
        getGraphemeBreakType(codePoint) {
            ...
            if (codePoint < 32) {
                if (codePoint === charCode_1.CharCode.LineFeed) {
                    return GraphemeBreakType.LF;
                }
                if (codePoint === charCode_1.CharCode.CarriageReturn) {
    ...
    */
    function $ag(offset, str) {
        ...
        const iterator = new $Nf(str, offset);
    ...
    function getOffsetBeforeLastEmojiComponent(initialOffset, str) {
        ...
        // structure of emojis.
        const iterator = new $Nf(str, initialOffset);
    ...
    class $cg {
        ...
        static { this.d = new cache_1.$$e({ getCacheKey: JSON.stringify }, (locales) => {
        ...
        static getInstance(locales) {
            return $cg.d.get(Array.from(locales));
        }
        static { this.e = new lazy_1.$T(() => Object.keys($cg.c.value).filter((k) => !k.startsWith('_'))); }
        static getLocales() {
            return $cg.e.value;
        }
        constructor(f) {
    ...
    class $dg {
        ...
        static isInvisibleCharacter(codePoint) {
            return $dg.e().has(codePoint);
        }
        static containsInvisibleCharacter(str) {
            for (let i = 0; i < str.length; i++) {
                const codePoint = str.codePointAt(i);
                if (typeof codePoint === 'number' && $dg.isInvisibleCharacter(codePoint)) {
                    return true;
                }
            }
            return false;
...
define(__m[22/*vs/base/common/worker/simpleWorker*/], __M([0/*require*/,1/*exports*/,2/*vs/base/common/errors*/,5/*vs/base/common/event*/,4/*vs/base/common/lifecycle*/,19/*vs/base/common/objects*/,14/*vs/base/common/platform*/,21/*vs/base/common/strings*/]), function (require, exports, errors_1, event_1, lifecycle_1, objects_1, platform_1, strings) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class SimpleWorkerClient extends lifecycle_1.$Uc {
        constructor(workerFactory, moduleId, host) {
            ...
            const hostMethods = (0, objects_1.$oo)(host);
    ...
    function propertyIsEvent(name) {
        ...
        return name[0] === 'o' && name[1] === 'n' && strings.$Ef(name.charCodeAt(2));
    }
    function propertyIsDynamicEvent(name) {
        // Assume a property is a dynamic event (a method that returns an event) if it has a form of "onDynamicSomething"
        return /^onDynamic/.test(name) && strings.$Ef(name.charCodeAt(9));
    }
    ...
    class SimpleWorkerServer {
        ...
        g(workerId, loaderConfig, moduleId, hostMethods) {
            ...
            if (this.a) {
                ...
                return Promise.resolve((0, objects_1.$oo)(this.b));
            }
            if (loaderConfig) {
